...
if os.name == "nt":
    ...
    winGPUdll = os.path.join(cwd, "vehicle.dll")
    winNoGPUdll = os.path.join(cwd, "vehicle.dll")
    envKeys = list()
...
def performDetect(imagePath="data/dog.jpg", thresh=0.25, configPath="./cfg/vehicle.cfg", weightPath="vehicle.weights",
...
def performBatchDetect(thresh=0.25, configPath="./cfg/vehicle.cfg", weightPath="vehicle.weights",
