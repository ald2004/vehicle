...
def do_python_eval(devkit_path, year, image_set, classes, output_dir='results'):
    print(f"devkit_path:{devkit_path}, year:{year}, image_set:{image_set}, classes:{classes}, output_dir:{output_dir}")
    #devkit_path:., year:2017, image_set:test, classes:['car', 'truck', 'bus', 'motorcycle', 'bicycle', 'trains'],
    # output_dir:/home/yuanpu/vehicle/data/MIO-TCD-Localization/evaluator/results
...
if __name__ == '__main__':
    ...
    #mkdir result;darknet detector valid data/chefCap.data cfg/chefCap.cfg weights/chefCap_diounms_mosaic_20000.weights
    #python vehicle_eval.py --voc_dir . --classes vehicle.names results
